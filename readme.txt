百度地图Android SDK v2.1.3 Sample共有15个Demo,每个Demo的说明如下：
...
详述：
（1）可自定义更换位置图标；
（2）百度地图SDK从2.0.0版本起，将定位功能进行了分离，具体使用方法请见定位SDK；
（3）定位SDK开发指南详见http://developer.baidu.com/map/geosdk-android.htm；
-------------------------------------------------------------------------------------
六、
Demo名称：自定义绘制功能
